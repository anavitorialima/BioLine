...
document.addEventListener('DOMContentLoaded', () => {
        ...
        onValue(postsRef,(snapshot)=>{
            ...
            if(posts){
                ...
                postsIds.forEach((postId) =>{
                    ...
                    if(categoria === 'geral' || categoria === categoria){ dadosPost()
        ...
        onValue(postsRef,(snapshot)=>{
            ...
            if (posts){
                ...
                postIds.forEach((postId)=>{
                    ...
                    const postElement = document.createElement('div')
                    postElement.innerHTML=`
                    <button class="btn btn-danger btn-sm mx-3 delete-post" data-id="${postId}" ><i class="bi bi-trash3-fill"></i> Apagar</button>
    ...
    if(centroOeste){
        listarPosts(centro-oeste, 'centro-oeste')
    }
    if(sudeste){
